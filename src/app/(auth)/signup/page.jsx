  ...
  return (
    <div className="min-h-screen w-full bg-[#fff7f2] flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
      ...
      >
        ...
        >
          <motion.div variants={itemVariants}>
            <TextField isRequired name="fullName">
              ...
              <InputGroup className="rounded-xl border border-gray-200 focus-within:border-orange-500 transition-colors bg-gray-50/50">
        ...
        <motion.div variants={itemVariants}>
          <Button
            className="w-full rounded-xl border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 hover:border-orange-300 transition-colors h-12"
            variant="bordered"
          >
